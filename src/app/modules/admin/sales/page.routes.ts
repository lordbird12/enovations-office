        ...
        children : [
            {
                ...
                resolve  : {
                    ...
                    machine_model: () => inject(PageService).getMachineModelByTeam(1), 
                    // products  : () => inject(InventoryService).getProducts(),
                    // tags      : () => inject(InventoryService).getTags(),
                    // vendors   : () => inject(InventoryService).getVendors(),
                },
            ...
            },
            {
                ...
                resolve  : {
                    ...
                    user: () => inject(PageService).getUser(),
                    client: () => inject(PageService).getClient(),
                    machine_model: () => inject(PageService).getMachineModelByTeam(3), 
                    // products  : () => inject(InventoryService).getProducts(),
                    // tags      : () => inject(InventoryService).getTags(),
                    // vendors   : () => inject(InventoryService).getVendors(),
                },
            ...
            },
            {
                ...
                resolve  : {
                    ...
                    user: () => inject(PageService).getUser(),
                    client: () => inject(PageService).getClient(),
                    machine_model: () => inject(PageService).getMachineModelByTeam(2), 
                    // products  : () => inject(InventoryService).getProducts(),
                    // tags      : () => inject(InventoryService).getTags(),
                    // vendors   : () => inject(InventoryService).getVendors(),
                },
            ...
            },
            {
                ...
                resolve  : {
                    ...
                    user: () => inject(PageService).getUser(),
                    client: () => inject(PageService).getClient(),
                    machine_model: () => inject(PageService).getMachineModelByTeam(4), 
                    // products  : () => inject(InventoryService).getProducts(),
                    // tags      : () => inject(InventoryService).getTags(),
                    // vendors   : () => inject(InventoryService).getVendors(),
                },
